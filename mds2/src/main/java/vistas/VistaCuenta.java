...
public class VistaCuenta extends LitTemplate {
	...
	@Id("img")
	private Image img;
	@Id("container_boton_cambiar_imagen")
	private Element container_boton_cambiar_imagen;
	...
	public Element getContainer_boton_cambiar_imagen() {
		return container_boton_cambiar_imagen;
	}

	public void setContainer_boton_cambiar_imagen(Element container_boton_cambiar_imagen) {
		this.container_boton_cambiar_imagen = container_boton_cambiar_imagen;
	}
	...
	public void setBoton_cambiar_contrasena(Button boton_cambiar_contrasena) {
