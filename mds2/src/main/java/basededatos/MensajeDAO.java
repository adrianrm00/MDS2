...
public class MensajeDAO {
	...
	public static Mensaje loadMensajeByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Mensaje) session.load(basededatos.Mensaje.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje getMensajeByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Mensaje) session.get(basededatos.Mensaje.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje loadMensajeByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Mensaje) session.load(basededatos.Mensaje.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje getMensajeByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Mensaje) session.get(basededatos.Mensaje.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(basededatos.Mensaje mensaje) throws PersistentException {
		try {
			basededatos.MDS1GarciaRodriguezPersistentManager.instance().saveObject(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basededatos.Mensaje mensaje) throws PersistentException {
		try {
			basededatos.MDS1GarciaRodriguezPersistentManager.instance().deleteObject(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(basededatos.Mensaje mensaje)throws PersistentException {
		try {
			if (mensaje.getUsuario_Reg() != null) {
				mensaje.getUsuario_Reg().setMensaje(null);
			}
			
			basededatos.Administrador[] lAdministradors = mensaje.administrador.toArray();
			for(int i = 0; i < lAdministradors.length; i++) {
				lAdministradors[i].setMensaje(null);
			}
	...
	public static boolean refresh(basededatos.Mensaje mensaje) throws PersistentException {
		try {
			basededatos.MDS1GarciaRodriguezPersistentManager.instance().getSession().refresh(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basededatos.Mensaje mensaje) throws PersistentException {
		try {
			basededatos.MDS1GarciaRodriguezPersistentManager.instance().getSession().evict(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
