...
public class MDS1GarciaRodriguezPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MDS1GarciaRodriguez";
	...
	private MDS1GarciaRodriguezPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basededatos.Usuario_Reg.class);
		aMetadataSources.addAnnotatedClass(basededatos.Artista.class);
		aMetadataSources.addAnnotatedClass(basededatos.Compositor.class);
		aMetadataSources.addAnnotatedClass(basededatos.Productor.class);
		...
		aMetadataSources.addAnnotatedClass(basededatos.Notificacion.class);
		aMetadataSources.addAnnotatedClass(basededatos.Cancion.class);
		aMetadataSources.addAnnotatedClass(basededatos.Evento.class);
		aMetadataSources.addAnnotatedClass(basededatos.Interprete.class);
		aMetadataSources.addAnnotatedClass(basededatos.Mensaje.class);
		aMetadataSources.addAnnotatedClass(basededatos.Lista.class);
		aMetadataSources.addAnnotatedClass(basededatos.EstilosMusica.class);
		aMetadataSources.addAnnotatedClass(basededatos.CancionesFav.class);
		aMetadataSources.addAnnotatedClass(basededatos.Biblioteca.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MDS1GarciaRodriguezPersistentManager();
		}
