...
<vaadin-vertical-layout theme="" id="container_principal" style="width: 100%; height: 100%;">
 <vaadin-vertical-layout id="container_titulo" style="width: 100%; height: 20%; justify-content: center;">
  <label id="titulo_cambio_correo" style="font-size:32px; font-weight:bold; align-self: center;">Cambio de Correo</label>
 </vaadin-vertical-layout>
 <vaadin-vertical-layout id="container_tf" style="width: 100%; height: 60%; align-items: center;">
 ...
 <vaadin-vertical-layout id="container_botones" style="width: 100%; height: 20%; flex-direction: row; align-items: center; justify-content: center;">
