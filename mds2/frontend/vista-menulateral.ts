...
<vaadin-vertical-layout style="width: 100%; height: 100%;" id="container_pricipal">
 <vaadin-vertical-layout style="width: 100%; flex-direction: row;" id="container_inicio">
 ...
 <vaadin-vertical-layout style="width: 100%; flex-direction: row;" id="container_buscar">
 ...
 <vaadin-vertical-layout style="width: 100%; flex-direction: row;" id="container_tu_biblioteca">
 ...
 <vaadin-vertical-layout style="width: 100%; flex-direction: row;" id="container_crear_lista">
 ...
 <vaadin-vertical-layout style="width: 100%; flex-direction: row;" id="container_canciones_fav">
 ...
 <vaadin-vertical-layout style="width: 100%;" id="container_separador">
  <label style="width: 100%;" id="texto_separador">-----------------------------------</label>
 </vaadin-vertical-layout>
 <vaadin-vertical-layout style="width: 100%; height: 100%;" id="container_listas"></vaadin-vertical-layout>
</vaadin-vertical-layout>
`;
  }
