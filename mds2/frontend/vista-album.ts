...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 <vaadin-vertical-layout style="width: 100%; height: 100%; flex-direction: row;">
  ...
  <vaadin-vertical-layout style="width: 200%; height: 100%; justify-content: center;">
   <vaadin-vertical-layout style="width: 100%; justify-content: center;">
    <vaadin-text-field label="Nombre album:" placeholder="Nombre del album" style="width: 100%;"></vaadin-text-field>
    <vaadin-text-field label="Creado por:" placeholder="Nombre del artista" style="width: 100%;"></vaadin-text-field>
    <vaadin-text-field label="Fecha de edicion:" placeholder="Fecha de subida o algo asi" style="width: 100%;"></vaadin-text-field>
   </vaadin-vertical-layout>
  </vaadin-vertical-layout>
